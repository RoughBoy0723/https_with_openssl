...
void send_data_ssl(SSL* ssl, char* ct, char* file_name) {
	...
	char cnt_type1[] = "Content-Encoding: br\r\n";
	char cnt_type2[] = "Content-type: image/png\r\n";
	char cnt_type3[] = "Content-type: text/css\r\n\r\n";
	SSL_write(ssl, cnt_type1, strlen(cnt_type1));
	SSL_write(ssl, cnt_type2, strlen(cnt_type2));
	SSL_write(ssl, cnt_type3, strlen(cnt_type3));
